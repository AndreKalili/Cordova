...
function listarPedidos() {
  cordova.plugin.http.get("https://pedidos-pizzaria.glitch.me/admin/pizzas/andre", {}, {},
    function (okResponse) {
...
function deletarpizza() {
  ...
  cordova.plugin.http.delete(encodeURI("https://pedidos-pizzaria.glitch.me/admin/pizza/andre/" + nomepizza),
    {}, {},
    function (okResponse) {
      listarPedidos()
